...
Specs are really week. This code is bit hackish but is being used by quite a few people. Migrating away from Jeweler to a hand coded gemspec and also using bundler would be nice.
